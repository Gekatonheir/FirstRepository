...
public class Airplane {
    ...
    public static void compare(Airplane x, Airplane y) {
        if (x.length > y.length)
            System.out.println("Самолет " + x.model + " ,длиннее, чем самолет " + y.model);
        else
            System.out.println("Самолет " + y.model + " ,длиннее, чем самолет " + x.model);
    }
}
